...
```
COMMENT: 
The Moran I test isstatistically significant with a practical value of 0.58 of autocorrelation
...
load data for the baseline_monthly layer
```{r}
Aqueduct_gdb <- st_read("data/Aqueduct40_waterrisk/GDB/Aq40_Y2023D07M05.gdb",
                        layer = "baseline_monthly")
```

Save the dataset filtered as a shape file
```{r}
# delate the file if it already exists
if (file.exists("Aqueduct_Serbia.shp")) {
    file.remove("Aqueduct_Serbia.shp")
}
