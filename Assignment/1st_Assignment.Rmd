...
```{r}
pop_sum_1991 <- sum(Brazil$`1991`, na.rm = TRUE)
pop_sum_2000 <- sum(Brazil$`2000`, na.rm = TRUE)
pop_sum_2010 <- sum(Brazil$`2010`, na.rm = TRUE)
```
...
FINAL COMPARISO: SCEGLIETE VOI QUALI VOLETE TENERE E PROVATE ALTRE PROJECTIONS
```{r}
